...
import { useState } from 'react';
  ...
  export default function Contacto() {
    ...
    function enviarEmail(e) {
      e.preventDefault();
      emailjs.sendForm('service_cgppkm2', 'template_09s3yyj', '#formulario', 'Eaf0ierSu82dMfP4C')
        .then((result) => {
            ...
            <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
              ...
              <Stack
                ...
                <Stack
                  ...
                  <Link href="https://www.linkedin.com/in/diego-clemente-927b6214a/">
                    <IconButton
                      aria-label="linkedin"
                      variant="ghost"
                      size="lg"
                ...
                <Box
                  ...
                  shadow="base">
                  <VStack spacing={5}>
                    <form onSubmit={enviarEmail} id='formulario'>
                    <FormControl isRequired>
                      <FormLabel>Nombre</FormLabel>
  
                      <InputGroup>
                        <InputLeftElement children={<BsPerson />} />
                        <Input onChange={onChange} type="text" id="nombre" name="name" placeholder="Escribe tu nombre" />
                      </InputGroup>
                    </FormControl>
